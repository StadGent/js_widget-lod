import { p as proxyCustomElement, H, h, F as Fragment } from './p-a8bc01a6.js';
import { i as isNumber, g as getQueryWithoutLimit, a as getFormattedObjectValue } from './p-a98ce3c7.js';
...
const LodTable$1 = /*@__PURE__*/ proxyCustomElement(class LodTable extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return LodTableStyle0; }
}, [0, "lod-table", {
        "endpoint": [1],
        "query": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["lod-table"];
    components.forEach(tagName => { switch (tagName) {
        case "lod-table":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, LodTable$1);
            }
            break;
    } });
}
...
const LodTable = LodTable$1;
const defineCustomElement = defineCustomElement$1;

export { LodTable, defineCustomElement };

//# sourceMappingURL=lod-table.js.map